...
import (
	...
	"github.com/cat3306/ginctl/api"
	"github.com/cat3306/ginctl/bug"
	"github.com/cat3306/ginctl/docker"
	"github.com/cat3306/ginctl/env"
	"github.com/cat3306/ginctl/gateway"
	"github.com/cat3306/ginctl/internal/cobrax"
	"github.com/cat3306/ginctl/internal/version"
...
var (
	//go:embed usage.tpl
	usageTpl string
	rootCmd  = cobrax.NewCommand("ginctl")
)
